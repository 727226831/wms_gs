...
public class ActivityBillListBindingImpl extends ActivityBillListBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.l_ccode, 3);
        sViewsWithIds.put(R.id.tv_title1, 4);
        sViewsWithIds.put(R.id.iv_ccode, 5);
        sViewsWithIds.put(R.id.et_ccode, 6);
        sViewsWithIds.put(R.id.iv_clear, 7);
        sViewsWithIds.put(R.id.b_submit, 8);
        sViewsWithIds.put(R.id.b_delete, 9);
    }
    // views
    @NonNull
    ...
    public ActivityBillListBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }
    private ActivityBillListBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
