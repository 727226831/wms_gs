...
public class ActivityBillDetailBindingImpl extends ActivityBillDetailBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.l_cwhcode, 3);
        sViewsWithIds.put(R.id.tv_title1, 4);
        sViewsWithIds.put(R.id.iv_cwhcode, 5);
    ...
    public ActivityBillDetailBindingImpl(@Nullable android.databinding.DataBindingComponent bindingComponent, @NonNull View root) {
        this(bindingComponent, root, mapBindings(bindingComponent, root, 10, sIncludes, sViewsWithIds));
    }
    private ActivityBillDetailBindingImpl(android.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
